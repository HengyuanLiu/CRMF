...
sed -e "/.PureJavaCrc32C/d" $basepath/../test_for_class/allclasses.txt > $basepath/../test_for_class/allclasses_exclude.txt
defects4j mutation -i $basepath/../test_for_class/allclasses_exclude.txt
rm -rf $basepath/../test_for_class/allclasses_exclude.txt
